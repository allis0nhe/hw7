...
# Your name: Allison He
# Your student id: 39784991
# Your email: heaa@umich.edu
...
def birthyear_nationality_search(age, country, cur, conn):
    ...
    return [(name, nationality, birthyear) for name, nationality, birthyear in results]
...
def position_birth_search(position, age, cur, conn):
    ...
    """, (position, year))
    results = cur.fetchall()
    return [(name, position, birthyear) for name, position, birthyear in results]
